...
//        com.wz.test.Person bean = ac.getBean(com.wz.test.Person.class);
...
//        com.wz.test.Person person = ac.getBean("person", com.wz.test.Person.class);
//        ac.close();
//        com.wz.test.Person person2 = ac.getBean("person", com.wz.test.Person.class);
