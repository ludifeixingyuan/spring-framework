...
----
	...
	Mono<com.wz.test.Person> result = client.get()
			.uri("/persons/{id}", id).accept(MediaType.APPLICATION_JSON)
			.retrieve()
			.bodyToMono(com.wz.test.Person.class);
----
[source,kotlin,indent=0,subs="verbatim,quotes",role="secondary"]
.Kotlin
----
...
----
	Mono<com.wz.test.Person> result = client.get()
			.uri("/persons/{id}", id).accept(MediaType.APPLICATION_JSON)
			.exchange()
			.flatMap(response -> response.bodyToMono(com.wz.test.Person.class));
----
[source,kotlin,indent=0,subs="verbatim,quotes",role="secondary"]
.Kotlin
----
...
.Java
----
	Mono<ResponseEntity<com.wz.test.Person>> result = client.get()
			.uri("/persons/{id}", id).accept(MediaType.APPLICATION_JSON)
			.exchange()
			.flatMap(response -> response.toEntity(com.wz.test.Person.class));
----
[source,kotlin,indent=0,subs="verbatim,quotes",role="secondary"]
.Kotlin
----
...
.Java
----
	Mono<com.wz.test.Person> personMono = ... ;

	Mono<Void> result = client.post()
			.uri("/persons/{id}", id)
			.contentType(MediaType.APPLICATION_JSON)
			.body(personMono, com.wz.test.Person.class)
			.retrieve()
...
.Kotlin
----
	val personDeferred: Deferred<com.wz.test.Person> = ...

	client.post()
			.uri("/persons/{id}", id)
			.contentType(MediaType.APPLICATION_JSON)
			.body<com.wz.test.Person>(personDeferred)
			.retrieve()
			.awaitBody<Unit>()
----
...
.Java
----
	Flux<com.wz.test.Person> personFlux = ... ;

	Mono<Void> result = client.post()
			.uri("/persons/{id}", id)
			.contentType(MediaType.APPLICATION_STREAM_JSON)
			.body(personFlux, com.wz.test.Person.class)
			.retrieve()
			.bodyToMono(Void.class);
----
[source,kotlin,indent=0,subs="verbatim,quotes",role="secondary"]
.Kotlin
----
	val people: Flow<com.wz.test.Person> = ...
...
----
	...
	builder.part("jsonPart", new com.wz.test.Person("Jason"));
...
----
	val builder = MultipartBodyBuilder().apply {
		...
		part("jsonPart", new com.wz.test.Person("Jason"))
...
.Java
----
	com.wz.test.Person person = client.get().uri("/person/{id}", i).retrieve()
		.bodyToMono(com.wz.test.Person.class)
		.block();

	List<com.wz.test.Person> persons = client.get().uri("/persons").retrieve()
		.bodyToFlux(com.wz.test.Person.class)
		.collectList()
		.block();
----
[source,kotlin,indent=0,subs="verbatim,quotes",role="secondary"]
...
.Java
----
	Mono<com.wz.test.Person> personMono = client.get().uri("/person/{id}", personId)
			.retrieve().bodyToMono(com.wz.test.Person.class);
	...
	val data = runBlocking {
			val personDeferred = async {
				client.get().uri("/person/{id}", personId)
						.retrieve().awaitBody<com.wz.test.Person>()
			}
