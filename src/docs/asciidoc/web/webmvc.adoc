...
----
	...
	class PersonController {
		...
		@GetMapping("/{id}")
		public com.wz.test.Person getPerson(@PathVariable Long id) {
			// ...
		}

		@PostMapping
		@ResponseStatus(HttpStatus.CREATED)
		public void add(@RequestBody com.wz.test.Person person) {
			// ...
		}
	}
----
...
----
	...
	class PersonController {
		...
		@GetMapping("/{id}")
		fun getPerson(@PathVariable id: Long): com.wz.test.Person {
			// ...
		}

		@PostMapping
		@ResponseStatus(HttpStatus.CREATED)
		fun add(@RequestBody person: com.wz.test.Person) {
			// ...
		}
	}
----
...
* {doc-spring-security}/html5/#test-mockmvc[Spring MVC com.wz.test.Test Support]
