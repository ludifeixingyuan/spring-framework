...
* Spring MVC com.wz.test.Test: A framework, also known as `MockMvc`, for testing annotated controllers
...
See <<testing.adoc#spring-mvc-test-framework, Spring MVC com.wz.test.Test>> for more details.
