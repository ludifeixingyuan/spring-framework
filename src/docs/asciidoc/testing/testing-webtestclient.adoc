...
----
	client.get().uri("/persons")
			.exchange()
			.expectStatus().isOk()
			.expectBodyList(com.wz.test.Person.class).hasSize(3).contains(person);
----
[source,kotlin,indent=0,subs="verbatim,quotes",role="secondary"]
.Kotlin
----
	...
	client.get().uri("/persons")
			.exchange()
			.expectStatus().isOk()
			.expectBodyList<com.wz.test.Person>().hasSize(3).contains(person)
----
...
----
	...
	client.get().uri("/persons/1")
			.exchange()
			.expectStatus().isOk()
			.expectBody(com.wz.test.Person.class)
			.consumeWith(result -> {
...
.Java
----
	EntityExchangeResult<com.wz.test.Person> result = client.get().uri("/persons/1")
			.exchange()
			.expectStatus().isOk()
			.expectBody(com.wz.test.Person.class)
			.returnResult();
