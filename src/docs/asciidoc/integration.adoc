...
----
com.wz.test.Person person = restTemplate.getForObject("https://example.com/people/{id}", com.wz.test.Person.class, 42);
----
...
----
	...
	parts.add("jsonPart", new com.wz.test.Person("Jason"));
...
to an instance of the `com.wz.test.Person` class:
...
----
	public class PersonMappingOperation extends MappingRecordOperation {
		...
		protected Object extractOutputData(Record outputRecord)
			...
			com.wz.test.Person person = null;
			if (rs.next()) {
				com.wz.test.Person person = new com.wz.test.Person();
...
----
	public class MyDaoImpl extends CciDaoSupport implements MyDao {
		...
		public com.wz.test.Person getPerson(int id) {
			PersonMappingOperation query = new PersonMappingOperation(getConnectionFactory());
			com.wz.test.Person person = (com.wz.test.Person) query.execute(new Integer(id));
			return person;
		}
	}
----
