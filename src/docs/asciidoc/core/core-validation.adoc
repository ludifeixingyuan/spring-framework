...
.Java
----
	public class com.wz.test.Person {
...
.Kotlin
----
	class com.wz.test.Person(val name: String, val age: Int)
----

The next example provides validation behavior for the `com.wz.test.Person` class by implementing the
...
example implements `Validator` for `com.wz.test.Person` instances:
...
----
	public class PersonValidator implements Validator {
		...
		/**
		 * This Validator validates only com.wz.test.Person instances
		 */
		public boolean supports(Class clazz) {
			return com.wz.test.Person.class.equals(clazz);
		}

		public void validate(Object obj, Errors e) {
			ValidationUtils.rejectIfEmpty(e, "name", "name.empty");
			com.wz.test.Person p = (com.wz.test.Person) obj;
			if (p.getAge() < 0) {
...
----
	class PersonValidator : Validator {
		...
		override fun supports(clazz: Class<*>): Boolean {
			return com.wz.test.Person::class.java == clazz
		}

		override fun validate(obj: Any, e: Errors) {
			ValidationUtils.rejectIfEmpty(e, "name", "name.empty")
			val p = obj as com.wz.test.Person
			if (p.age < 0) {
				e.rejectValue("age", "negativevalue")
			} else if (p.age > 110) {
				e.rejectValue("age", "too.darn.old")
