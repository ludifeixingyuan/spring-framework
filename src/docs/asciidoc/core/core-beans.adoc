...
----
	<bean id="outer" class="...">
		...
		<property name="target">
			<bean class="com.example.com.wz.test.Person"> <!-- this is the inner bean -->
...
----
	<beans xmlns="http://www.springframework.org/schema/beans"
		...
		<bean name="john-classic" class="com.example.com.wz.test.Person">
			<property name="name" value="John Doe"/>
			<property name="spouse" ref="jane"/>
		</bean>

		<bean name="john-modern"
			class="com.example.com.wz.test.Person"
			p:name="John Doe"
			p:spouse-ref="jane"/>

		<bean name="jane" class="com.example.com.wz.test.Person">
...
----
	@EventListener
	public void onPersonCreated(EntityCreatedEvent<com.wz.test.Person> event) {
		// ...
	}
----
[source,kotlin,indent=0,subs="verbatim,quotes",role="secondary"]
...
----
	@EventListener
	fun onPersonCreated(event: EntityCreatedEvent<com.wz.test.Person>) {
		// ...
	}
----
...
`class PersonCreatedEvent extends EntityCreatedEvent<com.wz.test.Person> { ... }`).
