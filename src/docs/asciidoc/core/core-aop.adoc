...
----
	...
	public interface PersonService {
		...
		com.wz.test.Person getPerson(String personName, int age);
	}

	public class DefaultPersonService implements PersonService {

		public com.wz.test.Person getPerson(String name, int age) {
			return new com.wz.test.Person(name, age);
		}
	}
----
[source,kotlin,indent=0,subs="verbatim,quotes",role="secondary"]
...
----
	...
	interface PersonService {
		...
		fun getPerson(personName: String, age: Int): com.wz.test.Person
	}

	class DefaultPersonService : PersonService {

		fun getPerson(name: String, age: Int): com.wz.test.Person {
			return com.wz.test.Person(name, age)
		}
	}
----
